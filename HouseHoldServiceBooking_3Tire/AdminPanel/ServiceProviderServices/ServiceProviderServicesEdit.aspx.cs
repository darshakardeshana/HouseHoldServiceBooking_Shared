...
public partial class AdminPanel_ServiceProviderServices_ServiceProviderServicesEdit : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (Session["UserID"] != null)
        {
            entServiceProviderServices.UserID = Convert.ToInt32(Session["UserID"].ToString().Trim());
            entServiceProviderServices.ModifiedBy = Convert.ToInt32(Session["UserID"].ToString().Trim());
        }
