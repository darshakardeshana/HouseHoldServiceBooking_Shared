<%@ Page Title="" Language="C#" MasterPageFile="~/Content/ServiceProviderPanel.master" AutoEventWireup="true" CodeFile="ProfileEdit.aspx.cs" Inherits="ServiceProviderPanel_Profile_ProfileEdit" %>
    ...
    <asp:updatepanel runat="server" id="upCountryAddEdit">
        <ContentTemplate>
            <div class="container p-5" style="background: white; border: 1px dotted black">
                ...
                <div class="row mb-2">
                    <div class="col-md-8 offset-md-2">
                        <asp:CheckBox ID="cbCopyAddress" runat="server" AutoPostBack="true" OnCheckedChanged="cbCopyAddress_CheckedChanged"/>                        
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-8 offset-md-2">
                ...
                <div class="row mb-2">
                    <div class="col-md-12">
                        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-outline-success mr-3" Text="Add" ValidationGroup="vgServiceProvider" OnClick="btnAdd_Click" />
                        <asp:HyperLink ID="hlCancel" runat="server" CssClass="btn btn-outline-danger" NavigateUrl="~/ServiceProviderPanel/Profile/ProfileView.aspx" Text="Cancel"></asp:HyperLink>
                    </div>
                </div>
            </div>
        </ContentTemplate>
