...
public partial class ServiceProviderPanel_ServiceProviderServices_ServiceProviderServicesAddEdit : System.Web.UI.Page
{
    #region Parameter
    static int key = 0;
    #endregion Parameter
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            FillDropDownList();
            ddlServiceProviderID_SelectedIndexChanged(this, EventArgs.Empty);
    ...
    private void FillDropDownList()
    {
        ...
        ddlServiceProviderID.SelectedValue = Session["ServiceProviderID"].ToString();
        ddlServiceProviderID.Enabled = false;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        entServiceProviderServices.ModifiedBy = 2;
        entServiceProviderServices.UserID = 2;
